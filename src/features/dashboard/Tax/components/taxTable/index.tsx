...
export default function TaxTable({taxes}:{taxes:Tax}) {
                    ...
                    {Array.isArray(taxes) && taxes.length > 0 ? (
                        ...
                        <tr key={tax.tax_id} className="even:bg-gray-6">
                            ...
                            <td className="py-4 px-4 flex justify-center items-center gap-1">
                                <button className="w-10 bg-gray-200 p-1 rounded hover:bg-gray-300 flex justify-center" title="edit" onClick={() => console.log('edit')}>
                                ...
                                <button className="w-10 bg-red-200 p-1 rounded hover:bg-red-300 flex justify-center" title="delete" onClick={() => console.log('delete')}>
                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
